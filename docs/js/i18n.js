  ...
  const strings = {
    en: {
      ...
      inputLangs: {
        ...
        title: "More languages, ready for every Mac.",
        lead:
          "v2s asks Apple's Speech and Translation frameworks which languages your Mac supports. Regional variants are collapsed while meaningful script variants remain separate.",
    ...
    zh: {
      ...
      inputLangs: {
        eyebrow: "输入语言",
        title: "更多语言，适用于每台 Mac。",
        lead: "v2s 会向 Apple 的 Speech 与 Translation 框架查询当前 Mac 支持的语言；地区变体会被合并，但有实际意义的文字变体仍会保留。",
