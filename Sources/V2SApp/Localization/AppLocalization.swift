...
enum AppTextKey: String, CaseIterable {
    ...
    case captionLayout
    case captionLayoutTopDown
    case captionLayoutBottomUp
    case captionLayoutLeftToRight
    case captionLayoutRightToLeft
    ...
    case iosPrivateBadge
    case iosSourcePlaceholder
...
enum AppLocalization {
    ...
    private static let baseTables: [String: [String: String]] = [
        "en": [
            ...
            "captionLayoutTopDown": "Translation on top",
            "captionLayoutBottomUp": "Original on top",
            "captionLayoutLeftToRight": "Translation on the left",
            "captionLayoutRightToLeft": "Original on the left",
            ...
            "quit": "Quit",
            "sourceShort": "Source",
            "advancedSettingsWindowTitle": "Easy2say Advanced Settings",
            ...
            "appAudioCapturePermissionDenied": "App audio capture permission was denied. Allow Easy2say to capture audio from other apps, then reopen the app.",
            ...
            "updates": "Updates",
            "openAtLogin": "Open Easy2say at Login",
            ...
            "iosPrivateBadge": "On-device · Private",
            "iosSourcePlaceholder": "Tap Start and speak naturally.",
            ...
            "iosCopyAll": "Copy All",
            "iosCaptionScale": "Caption Size",
            "iosAccent": "Caption Accent",
            "iosAccentIce": "Ice",
            "iosAccentMint": "Mint",
        ...
        "zh-Hans": [
            ...
            "captionLayout": "字幕排列",
            "captionLayoutTopDown": "译文在上",
            "captionLayoutBottomUp": "原文在上",
            "captionLayoutLeftToRight": "译文在左",
            "captionLayoutRightToLeft": "原文在左",
            ...
            "quit": "退出",
            "sourceShort": "来源",
            "advancedSettingsWindowTitle": "Easy2say 高级设置",
            ...
            "appAudioCapturePermissionDenied": "应用音频采集权限被拒绝。请允许 Easy2say 采集其他应用的音频，然后重新打开应用。",
            ...
            "iosPrivateBadge": "全程设备端 · 私密",
            "iosSourcePlaceholder": "轻点“开始”，然后自然说话。",
        ...
        "zh-Hant": [
            ...
            "stop": "停止",
            "wait": "等待",
            "pleaseDownloadLanguageResource": "請先下載語言資源",
            "general": "一般",
            "sessionState": "工作階段狀態",
            "status": "狀態",
            "interfaceLanguage": "介面語言",
            "showSubtitlePreview": "顯示字幕預覽",
            "inputSource": "輸入來源",
            "selectedSource": "已選輸入來源",
            "allSources": "全部來源",
            "allInternalSources": "全部內部來源",
            "allDeviceSources": "全部設備來源",
            "multipleSourcesFormat": "%d 個來源",
            "noSourcesDetected": "未偵測到輸入來源",
            "noSources": "沒有可用的輸入來源",
            "choose": "選擇...",
            "done": "完成",
            "refreshSources": "重新整理輸入來源",
            "languages": "語言",
            "defaultInputLanguage": "預設輸入語言",
            "defaultSubtitleLanguage": "預設字幕語言",
            "useDefaultFormat": "使用預設值（%@）",
            "inputLanguage": "輸入語言",
            ...
            "modeShort": "模式",
            "subtitleMode": "字幕模式",
            "subtitleModeHelp": "說明各字幕模式的差異",
            "displayShort": "顯示",
            "subtitleDisplay": "字幕顯示",
            "subtitleDisplayBoth": "顯示雙語字幕",
            "subtitleDisplayOriginalOnly": "僅顯示原文字幕",
            "subtitleDisplayTranslatedOnly": "僅顯示譯文字幕",
            "captionLayout": "字幕排列",
            "captionLayoutTopDown": "譯文在上",
            "captionLayoutBottomUp": "原文在上",
            "captionLayoutLeftToRight": "譯文在左",
            "captionLayoutRightToLeft": "原文在左",
            "refreshLanguageResources": "重新整理語言資源",
            "glossary": "詞彙表",
            "glossaryEmpty": "尚未新增任何詞彙。點按 + 以新增「來源詞 -> 目標詞」項目。",
            "sourceTerm": "來源詞",
            "targetTerm": "目標詞",
            "subtitleOverlay": "字幕浮層",
            "textOutline": "文字外框",
            "outlineColor": "外框顏色",
            "attachToSource": "附著於來源應用程式",
            "invisibleInRecording": "錄影中隱藏",
            "invisibleInRecordingHint": "字幕仍會顯示在你的螢幕上，但不會出現在螢幕錄影、螢幕擷圖與螢幕分享中。",
            "subtitleColor": "字幕顏色",
            ...
            "quit": "結束",
            "sourceShort": "來源",
            "advancedSettingsWindowTitle": "Easy2say 進階設定",
            "subtitleModesWindowTitle": "字幕模式",
            "subtitleModeIntro": "依據你對延遲和句子完整度的偏好來選擇字幕模式。",
            "bestForFormat": "適合：%@",
            "tradeoffFormat": "折衷：%@",
            "targetsFormat": "目標：首字 %d 毫秒 · 原文提交 %d 毫秒 · 譯文提交 %d 毫秒",
            "idle": "閒置",
            "running": "執行中",
            "error": "錯誤",
            "application": "應用程式",
            ...
            "modeFollowName": "跟隨",
            "modeReadingName": "閱讀",
            "modeBalancedDetail": "適合大多數情境",
            "modeFollowDetail": "直播和會議",
            "modeReadingDetail": "講座和課程",
            "modeBalancedLong": "在回應速度和可讀的句子切分之間取得平衡。這是預設選項，適合想要字幕穩定且不會拖慢介面的情境。",
            "modeFollowLong": "更早提交並使用更短的切分，讓字幕更貼近即時語音。它反應最快，但較長的表達會被拆成更多片段。",
            "modeReadingLong": "等待更完整的詞組和更完整的翻譯。更適合講座或資訊密集內容的閱讀，但出現在螢幕上的時間會更晚。",
            "modeBalancedBestFor": "日常通話、影片和混合使用情境",
            "modeFollowBestFor": "即時會議、直播和快節奏的往返對話",
            "modeReadingBestFor": "講座、課程以及更看重完整句子的內容",
            "modeBalancedTradeoff": "不是最快，也不是最完整",
            "modeFollowTradeoff": "延遲更低，但字幕片段更碎",
            "modeReadingTradeoff": "可讀性更好，但延遲更高",
            "ready": "就緒",
            "runningOnFormat": "正在處理 %@",
            "chooseInputSourceBeforeStarting": "開始前請先選擇輸入來源。",
            "checkingLanguageResources": "正在檢查語言資源...",
            "downloadRequiredLanguageResourcesSystemSettings": "請在 macOS 系統設定中下載所需的語言資源。",
            "preparingSourceFormat": "正在準備 %@...",
            "showingOverlayPreview": "正在顯示浮層預覽。",
            "waitingForAudioFromFormat": "正在等待來自 %@ 的音訊...",
            "listening": "正在聆聽...",
            "captureStopped": "擷取已停止",
            "unableToStart": "無法啟動",
            "speechTitleFormat": "語音辨識 · %@",
            "translationTitleFormat": "翻譯 · %@ → %@",
            "speechNotAvailableOnMacOS": "目前的 macOS 版本不支援此語言的語音辨識。",
            "speechUsesAppleServersFormat": "本機沒有%@的裝置端語音模型，辨識將由 Apple 的伺服器處理。",
            ...
            "speechResourceDownloadTimedOut": "自動下載語音辨識資源逾時。",
            "translationResourceDownloadTimedOut": "自動下載翻譯資源逾時。",
            "translationRequiresMacOS15OrNewer": "翻譯功能需要 macOS 15 或以上版本。",
            "translationUnsupportedFromToFormat": "目前不支援從 %@ 翻譯到 %@。",
            "speechPermissionDenied": "語音辨識權限遭拒絕。",
            "microphonePermissionDenied": "麥克風權限遭拒絕。",
            "appAudioCapturePermissionDenied": "應用程式音訊擷取權限遭拒絕。請允許 Easy2say 擷取其他應用程式的音訊，然後重新開啟應用程式。",
            "unsupportedSpeechLocaleFormat": "語音辨識不支援 %@。",
            "unavailableSpeechRecognizerFormat": "目前 %@ 的語音辨識無法使用。",
            "missingMicrophoneDevice": "所選麥克風已無法使用。",
            "missingApplicationFormat": "所選應用程式 %@ 已無法使用。",
            "applicationNotProducingAudioFormat": "%@ 目前尚未輸出應用程式音訊。請先在應用程式中開始播放，再重試。",
            "failedToStartCaptureFormat": "%@",
            "sileroVadUnavailableFallbackFormat": "Silero VAD 無法使用：%@。將回退至以 ASR 為基礎的靜音偵測。",
            "speechRecognitionStoppedFormat": "語音辨識已停止：%@",
            "couldNotAddSelectedMicrophoneToCaptureSession": "無法將所選麥克風加入擷取工作階段。",
            "couldNotAddMicrophoneAudioOutput": "無法為麥克風擷取工作階段加入音訊輸出。",
            "failedToCopyCapturedAudioForSpeechPreprocessing": "無法複製用於語音前置處理的擷取音訊。",
            "failedToPrepareSpeechPreprocessingAudioConverter": "無法準備語音前置處理音訊轉換器。",
            "failedToAllocateSpeechPreprocessingAudioBuffer": "無法分配語音前置處理音訊緩衝區。",
            "failedToPreprocessCapturedAudio": "無法前置處理擷取音訊",
            "failedToPrepareAudioConverterForSpeechRecognition": "無法準備語音辨識音訊轉換器。",
            "failedToAllocateSpeechRecognitionAudioBuffer": "無法分配語音辨識音訊緩衝區。",
            "failedToConvertCapturedAudioForSpeechRecognition": "無法將擷取音訊轉換為語音辨識格式",
            "failedToAllocateSpeechAnalyzerAudioBuffer": "無法分配 SpeechAnalyzer 音訊緩衝區。",
            "failedToConvertCapturedAudioForSpeechAnalyzer": "無法將擷取音訊轉換為 SpeechAnalyzer 格式",
            "noOutputAudioDeviceForAppCapture": "應用程式擷取沒有可用的音訊輸出裝置。",
            "selectedAppAudioFormatCouldNotBePrepared": "無法為擷取準備所選應用程式的音訊格式。",
            "failedToStageWithReasonFormat": "無法%@：%@",
            "failedToReadCapturedAudioStreamFormat": "無法讀取 %@ 的擷取音訊串流。",
            "scrollToLatestSubtitle": "捲動至最新字幕",
            "resetOverlaySize": "重置字幕視窗大小",
            "transcript": "字幕紀錄",
            "origin": "原文",
            "translation": "譯文",
            "summarize": "摘要",
            "clear": "清除",
            "copy": "拷貝",
            "transcriptWindowTitle": "字幕紀錄",
            "summarizationRequiresMacOS26": "摘要功能需要 macOS 26 或以上版本。",
            "updates": "更新",
            "openAtLogin": "登入時開啟 Easy2say",
            "enableAtLoginInSystemSettings": "請前往「系統設定」>「一般」>「登入項目」完成啟用。",
            "openLoginItems": "打開登入項目",
            "launchAtLoginUpdateFailedFormat": "無法更新登入時啟動設定：%@",
            "checkForUpdatesAutomatically": "自動檢查更新",
            "checkForUpdates": "檢查更新",
            "iosPrivateBadge": "全程裝置端 · 私密",
            "iosSourcePlaceholder": "點一下「開始」，接著自然說話。",
        ...
        "es": [
            ...
            "captionLayout": "Disposición de subtítulos",
            "captionLayoutTopDown": "Traducción arriba",
            "captionLayoutBottomUp": "Original arriba",
            "captionLayoutLeftToRight": "Traducción a la izquierda",
            "captionLayoutRightToLeft": "Original a la izquierda",
            ...
            "quit": "Salir",
            "sourceShort": "Fuente",
            "advancedSettingsWindowTitle": "Configuración avanzada de Easy2say",
            ...
            "appAudioCapturePermissionDenied": "Se denegó el permiso para capturar el audio de aplicaciones. Permite que Easy2say capture audio de otras apps y vuelve a abrir la app.",
            ...
            "openAtLogin": "Abrir Easy2say al iniciar sesión",
        ...
        "de": [
            ...
            "captionLayout": "Untertitel-Anordnung",
            "captionLayoutTopDown": "Übersetzung oben",
            "captionLayoutBottomUp": "Original oben",
            "captionLayoutLeftToRight": "Übersetzung links",
            "captionLayoutRightToLeft": "Original links",
            ...
            "quit": "Beenden",
            "sourceShort": "Quelle",
            "advancedSettingsWindowTitle": "Easy2say Erweiterte Einstellungen",
            ...
            "appAudioCapturePermissionDenied": "Die Berechtigung zur App-Audioaufnahme wurde verweigert. Erlaube Easy2say, Audio aus anderen Apps aufzunehmen, und öffne die App dann erneut.",
            ...
            "updates": "Updates",
            "openAtLogin": "Easy2say bei der Anmeldung öffnen",
        ...
        "ja": [
            ...
            "captionLayout": "字幕レイアウト",
            "captionLayoutTopDown": "訳文を上に",
            "captionLayoutBottomUp": "原文を上に",
            "captionLayoutLeftToRight": "訳文を左に",
            "captionLayoutRightToLeft": "原文を左に",
            ...
            "quit": "終了",
            "sourceShort": "ソース",
            "advancedSettingsWindowTitle": "Easy2say 詳細設定",
            ...
            "appAudioCapturePermissionDenied": "アプリ音声の収集権限が拒否されました。Easy2say が他のアプリの音声を取得できるようにした後、アプリを再度開いてください。",
            ...
            "updates": "アップデート",
            "openAtLogin": "ログイン時に Easy2say を開く",
        ...
        "fr": [
            ...
            "captionLayout": "Disposition des sous-titres",
            "captionLayoutTopDown": "Traduction en haut",
            "captionLayoutBottomUp": "Original en haut",
            "captionLayoutLeftToRight": "Traduction à gauche",
            "captionLayoutRightToLeft": "Original à gauche",
            ...
            "quit": "Quitter",
            "sourceShort": "Source",
            "advancedSettingsWindowTitle": "Réglages avancés Easy2say",
            ...
            "appAudioCapturePermissionDenied": "L'autorisation de capture audio des apps a été refusée. Autorisez Easy2say à capturer l'audio des autres apps, puis rouvrez l'app.",
            ...
            "openAtLogin": "Ouvrir Easy2say à la connexion",
        ...
        "ko": [
            ...
            "captionLayout": "자막 배치",
            "captionLayoutTopDown": "번역 위",
            "captionLayoutBottomUp": "원문 위",
            "captionLayoutLeftToRight": "번역 왼쪽",
            "captionLayoutRightToLeft": "원문 왼쪽",
            ...
            "quit": "종료",
            "sourceShort": "소스",
            "advancedSettingsWindowTitle": "Easy2say 고급 설정",
            ...
            "appAudioCapturePermissionDenied": "앱 오디오 캡처 권한이 거부되었습니다. Easy2say가 다른 앱의 오디오를 캡처할 수 있도록 허용한 뒤 앱을 다시 여세요.",
        ...
        "ar": [
            ...
            "captionLayout": "تصميم الترجمة",
            "captionLayoutTopDown": "الترجمة في الأعلى",
            "captionLayoutBottomUp": "الأصل في الأعلى",
            "captionLayoutLeftToRight": "الترجمة على اليسار",
            "captionLayoutRightToLeft": "الأصل على اليسار",
            ...
            "quit": "إنهاء",
            "sourceShort": "المصدر",
            "advancedSettingsWindowTitle": "إعدادات Easy2say المتقدمة",
            ...
            "appAudioCapturePermissionDenied": "تم رفض إذن التقاط صوت التطبيقات. اسمح لـ Easy2say بالتقاط الصوت من التطبيقات الأخرى ثم أعد فتح التطبيق.",
            ...
            "updates": "التحديثات",
            "openAtLogin": "فتح Easy2say عند تسجيل الدخول",
        ...
        "pt": [
            ...
            "captionLayout": "Disposição das legendas",
            "captionLayoutTopDown": "Tradução acima",
            "captionLayoutBottomUp": "Original acima",
            "captionLayoutLeftToRight": "Tradução à esquerda",
            "captionLayoutRightToLeft": "Original à esquerda",
            ...
            "quit": "Sair",
            "sourceShort": "Fonte",
            "advancedSettingsWindowTitle": "Configurações avançadas do Easy2say",
            ...
            "appAudioCapturePermissionDenied": "A permissão de captura de áudio de apps foi negada. Permita que o Easy2say capture áudio de outros apps e reabra o app.",
            ...
            "openAtLogin": "Abrir Easy2say ao iniciar sessão",
        ...
        "ru": [
            ...
            "captionLayout": "Расположение субтитров",
            "captionLayoutTopDown": "Перевод сверху",
            "captionLayoutBottomUp": "Оригинал сверху",
            "captionLayoutLeftToRight": "Перевод слева",
            "captionLayoutRightToLeft": "Оригинал слева",
            ...
            "advancedSettingsWindowTitle": "Расширенные настройки Easy2say",
            ...
            "appAudioCapturePermissionDenied": "Доступ к захвату звука приложений запрещен. Разрешите Easy2say захватывать звук из других приложений и снова откройте приложение.",
            ...
            "updates": "Обновления",
            "openAtLogin": "Открывать Easy2say при входе в систему",
