...
enum AppLocalization {
    ...
    static let tables: [String: [String: String]] = [
        ...
        "zh-Hant": [
            ...
            "onlyThreeControlsAcceptClicks": "只有這 3 個控制項目可以點按",
            "textOutline": "文字外框",
            "outlineColor": "外框顏色",
            ...
            "quit": "結束",
            "sourceShort": "來源",
            "advancedSettingsWindowTitle": "v2s 進階設定",
            "subtitleModesWindowTitle": "字幕模式",
            ...
            "appAudioCapturePermissionDenied": "應用程式音訊擷取權限遭拒絕。請允許 v2s 擷取其他應用程式的音訊，然後重新開啟應用程式。",
